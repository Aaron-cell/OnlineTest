        ...
        <h2><p style="color : red">${hint }</p></h2>
		 ...
		 <tr class="firstTr">
                ...
                <%
				   ...
				   list1=(List<TestGrade>)request.getAttribute("list1");
                %>
				    ...
				    <tr>
						...
						<td>${testrecord.description }</td>
						 ...
						 <td>${testrecord.testscore }</td>
							<%
								request.setAttribute("testgrade",list1.get(i++));
							%>
	                    ...
	                    <td>
		                   	<a href="AnswertheTest.do?id=${testrecord.testid }&username=${testgrade.username }"><img src="img/zd.png" alt="答题" title="答题"/></a>
	                    </td>
                    </tr>
